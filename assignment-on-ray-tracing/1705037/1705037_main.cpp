...
//                update image pixel (i,j)
   ...
   image.save_image("D://OneDrive//OneDrive - BUET//OneDrive//My L4-T1//CSE410//Offline 3//Ray Tracing//Output_1"+std::to_string(img_cap)+".bmp");
...
void loadData()
{
    std::ifstream in("D://OneDrive//OneDrive - BUET//OneDrive//My L4-T1//CSE410//Offline 3//Ray Tracing//scene.txt");
